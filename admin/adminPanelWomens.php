...
if(isset($_POST['submit'])){
   ...
   if(empty($product_name) || empty($product_price) || empty($product_image || empty($product_description))){
      ...
      $insert = "INSERT INTO womenproducts(productNameWomen, productPriceWomen, productDescriptionWomen, productPic1Women) VALUES('$product_name', '$product_price', '$product_description', '$product_image');";
...
<div class="container-fluid">
  ...
  <h2 class="U-section-heading"><center><a href="adminPanel.php" class="U-section-heading-anchor">ADMIN PANEL</a></center></h2>
    ...
    <div class="form-group">
      ...
      <div class="form-group">
		...
		<div class="form-group">
        <input type="file" name="productImage" class="form-control" accept="image/png, image/jpeg, image/jpg">
		</div>
  ...
  <thead class="U-table-head">
    ...
    <?php while($row = mysqli_fetch_assoc($select)){ ?>
         <tr>
            <td><img src="uploaded_img/women/<?php echo $row['productPic1Women']; ?>" height="100" alt=""></td>
            <td><?php echo $row['productNameWomen']; ?></td>
            <td><?php echo $row['productDescriptionWomen']; ?></td>
            <td>$<?php echo $row['productPriceWomen']; ?>/-</td>
            <td>
               <a href="updateWomens.adm.php?edit=<?php echo $row['productIdWomen']; ?>" class="btn"> <i class="fas fa-edit"></i> edit </a>
               <a href="deleteProductWomen.adm.php?delete=<?php echo $row['productIdWomen']; ?>" class="btn"> <i class="fas fa-trash"></i> delete </a>
            </td>
         </tr>
    <?php } ?>
  </tbody>
